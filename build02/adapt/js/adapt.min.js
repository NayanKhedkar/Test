    ...
    var Media = ComponentView.extend({
        ...
        setupPlayer: function() {
            ...
            */
            ...
            if (this.model.get('_useClosedCaptions')) {
                ...
                if (!Adapt.offlineStorage.get('captions-'+this.model.get('_id'))) {
                    Adapt.offlineStorage.set('captions-'+this.model.get('_id'), startLanguage);
                }
                modelOptions.startLanguage = this.checkForSupportedCCLanguage(Adapt.offlineStorage.get('captions-'+this.model.get('_id')));
            }
        ...
        listenForCaptionsChange: function() {
            ...
            this.$(selector).on('click.mediaCaptionsChange', _.debounce(function() {
                ...
                Adapt.offlineStorage.set('captions-'+this.model.get('_id'), srclang);
